...
#input: i0 = 3: E. Coli data, 4: S. cerevisiae data, dip = gene expression data matrix, 
#       add_mat = A matrix of 0/1, where the (i,j)th element is 1, if there is an edge between the ith and jth gene in the gold standard data, and 0 otherwise. 
#       p = # of correlated genes we are interested in, fixed to 100, n = # of samples to be used in testing, eta = determines the level of noise to be added to the expression data, see eqn. (25) for details.
#output: vector of classical and selective p-values, and effect size determined from the holdout data. 
