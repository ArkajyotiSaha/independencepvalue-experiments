library(amen)
# Given a sample covariance matrix (S), groups of variables (CP), and the group to be tested for independence with the remaining variables (k)
# compute the test statistic as a function of the canonical correlations. 
# This is a part of the output in independencepvalue:::test_stat_CCA().
