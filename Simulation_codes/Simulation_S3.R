...
#Code for simulation under global null with a given threshold for data with Poisson distribution.
#input: i0 = Seed, p = # of variables, n = # of samples, c0 = threshold, mu = mean of the Poisson distribution. 
#output: A vector of seletive and classical p-values.
eval_total <- function(i0, p, n, c0, mu) {
  set.seed(i0)
  X <- matrix(rpois(n * p, mu), n, p)#generate data from Poisson distribution under global null
